...
is_cupcake = 'no' # if set to 'yes' you can ignore the rest of the variables

machine_ppi = 2000  # Set equal to your machine's Steps Per Inch (steps per rotation * threads per inch)

machine_limit_x = 7 # Working envelope of your machine, in inches. This script assumes your machine's origin at (0,0,0)
machine_limit_y = 7
machine_limit_z = 7 
